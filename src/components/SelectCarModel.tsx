...
interface ISelectCarModelProps {
    listData?: {
        id?: number,
        name?: string,
        count?: number
...
const SelectCarModel: FC<ISelectCarModelProps> = ({ listData,callBack }) => {
    const [searchData, setSearchData] = useState<ISelectCarModelProps["listData"] | undefined>(listData);
